...
export const CombatEquipmentItemEditor = (
  ...
  const { equipmentList, handleWearEquipment, equippedItem } =
    useCombatEquipmentItemEditor(props?.type)

  return (
    <VStack>
      {equippedItem && (
        <EquipmentSummary equippedItem={equippedItem} />
      )}
      {equippedItem && <Divider orientation="horizontal" />}
      <SheetList>
